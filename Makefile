...
STATICDIR   = _static
STATIC_CSS  = themes/agramfort/static
SITE        = $(BUILDDIR)/html
...
# agramfort - new targets I've added after sphinx-quickstart
...
# git archive --prefix=agramfort.org/  master | gzip > gramfort.net.tgz
